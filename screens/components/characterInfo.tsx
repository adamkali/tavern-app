        ...
        <DefaultView>
            <DefaultView style={styles.leftWrapper}>
                <DefaultView style={styles.rowView}>
                    <Text style={styles.rowCellTitle}>Character:</Text>
            ...
            <DefaultView>
                ...
                <DefaultView style={styles.rowView}>
                    ...
                    <Text style={styles.rowCell}>{character.intelligence}</Text>
                ...
                <DefaultView style={styles.rowView}>
                    ...
                    <Text style={styles.rowCell}>
                        {modifier(character.intelligence)}
                    </Text>
                    <Text style={styles.rowCell}>
                        {modifier(character.wisdom)}
                    </Text>
                    <Text style={styles.rowCell}>
                        {modifier(character.charisma)}
                    </Text>
                </DefaultView>
                <Text style={styles.rowCell}>
                ...
                <Text style={styles.rowCell}>
                    Character Backstory: {character.back_story}
                </Text>
                <Text style={styles.rowCell}>
                    Character Traits: {character.character_traits}
                </Text>
            </DefaultView>
        </DefaultView>
    )
